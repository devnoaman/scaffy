...
function activate(context) {
 ...
 // After all terminal commands finish, ask user to open the project
 terminal.processId.then(() => {
	vscode.window.showInformationMessage(`Do you want to open the newly created Flutter app? (y/n)`).then((selection) => {
	  if (selection === 'y') {
