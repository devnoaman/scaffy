...
function activate(context) {
 ...
 // Create the project folder
    ...
    const terminal = vscode.window.createTerminal({
	  ...
	  terminal.sendText(`
		\n\n
		Scaffy project '${projectName}' created successfully!
		Do you want to open it? (y/n)
	  `);
	     // Listen for user input to open the project
		 vscode.window.onDidWriteTerminalData((e) => {
			if (e.data.trim().toLowerCase() === 'y') {
			...
			} else if (e.data.trim().toLowerCase() === 'n') {
			  vscode.window.showInformationMessage('You can open the app later.');
			}
		  });
